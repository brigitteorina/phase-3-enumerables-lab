...
def average_heat_level(spicy_foods)
  ...
  average_heat_level = total_heat_level.to_f / spicy_foods.length
...
puts get_names(foods)
puts spiciest_foods(foods)
print_spicy_foods(foods)
puts get_spicy_food_by_cuisine(foods, 'Thai')
puts sort_by_heat(foods)
print_spiciest_foods(foods)
puts average_heat_level(food
